 ...
 * Supports drag-to-rotate, momentum physics, auto-rotation, and hover animations.
 *
 * Features:
 ...
 * - Hover effects for enlarged display
      ...
      >
        ...
        {isHovered && image.title && (
          <div className="absolute -bottom-8 left-1/2 transform -translate-x-1/2 whitespace-nowrap pointer-events-none z-50">
            <div className="text-xs font-medium px-3 py-1 rounded-lg bg-gray-900/90 text-white border border-white/20">
              {image.title}
            </div>
          </div>
        )}
